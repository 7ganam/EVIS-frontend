...
let imagesData = [
    ...
    },
    {
        ...
        title: "Spokesman-Director of electrical and electronic standards Department",
        company: "SASO"
    },
    {
    ...
    },
    {
        ...
        name: "Mark Carson",
        title: "Customer Experience and Quality Director - Africa Middle East, Pacific",
    ...
    },
    {
        ...
        name: "Raed Kadri",
        title: "Vice-President, Strategic Initiatives, Ontario Centre of Innovation",
    ...
    },
    {
        ...
        title: "Head, World Ocean Initiative Senior Manager, Sustainability, Climate Change and Natural Resources",
    ...
    },
    {
        ...
        title: "CEO E3/DC + BU Vice President HagerGroup for Energy Management Development",
    ...
    return (
        <EvLayout showNavbar={true}>
            ...
            <Container maxWidth="false" sx={{
                ...
                <Box padding="80px">
                    <Container>
                        <Grid container rowSpacing={3} spacing={2} sx={{ padding: "35px", textAlign: "center", placeItems: "center", alignItems: "stretch" }}>
                            {imagesData?.slice(0, 8).map(({ imageSrc, name, title, company }) => {
                                return (
                                    <Grid item xs={12} sm={4}
                                        md={3} key={name}>
                                        <ModifiedRoundedImage Src={imageSrc} Name={name} Title={title} Company={company} bgColor={theme.palette.paste.contrastText} />

                                    </Grid>)
                            })}
                            {showAll && imagesData?.slice(8).map(({ imageSrc, name, title, company }) => {
                                return (
                                    <Grid item xs={12} sm={4}
                                        md={3} key={name}>
                                        <ModifiedRoundedImage Src={imageSrc} Name={name} Title={title} Company={company} bgColor={theme.palette.paste.contrastText} />
                    ...
                    }} onClick={() => setShowAll(true)}>Show All</Button>
                </Box>
            </Container>
            <Container>
                <SponsorsGrid />
