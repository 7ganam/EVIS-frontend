...
import { H2, H4, H5, Paragraph } from "components/EvComponents/Typography";
        ...
        <Box py={5}>
            <Container mb={6}>
                ...
                >
                    ...
                    >
                        <TodayIcon sx={{ fontSize: "40px", marginRight: "7px", marginLeft: "auto", verticalAlign: "middle", color: theme.palette.primary.main }} /><H4 sx={{ marginRight: "auto" }}>{nameData.date}</H4>
                    </Grid>
                    <Grid
                        item
                        xs={12}
