    ...
    return (
        <EvLayout showNavbar={true}>
            <Container sx={{
                ...
                <Grid container
                    sx={{ width: "800px", textAlign: "center", placeItems: "center", marginTop: "40px", }}
                >
                ...
                <Grid container
                    sx={{ width: "600px", textAlign: "center", placeItems: "center", marginTop: "40px" }}
                >
                    {sponsors.map(({ source }) => {
                        return (
                ...
                <Grid container columns={{ xs: 12, sm: 12, md: 10 }}
                    sx={{ width: "950px", textAlign: "center", placeItems: "center", marginTop: "40px" }}
                >
                ...
                <Grid container
                    sx={{ width: "450px", textAlign: "center", placeItems: "center", marginTop: "40px" }}
                >
