import BabyBoy from "src/components/icons/BabyBoy";
import BabyGirl from "src/components/icons/BabyGirl";
import Car from "src/components/icons/Car";
import Dress from "src/components/icons/Dress";
import Food from "src/components/icons/Food";
import Gift from "src/components/icons/Gift";
import Laptop from "src/components/icons/Laptop";
import MakeUp from "src/components/icons/MakeUp";
import Man from "src/components/icons/Man";
import Microphone from "src/components/icons/Microphone";
import MotorBike from "src/components/icons/MotorBike";
import Pets from "src/components/icons/Pets";
import PlantPot from "src/components/icons/PlantPot";
import TeddyBear from "src/components/icons/TeddyBear";
import Woman from "src/components/icons/Woman";
const navigations = [
  {
    icon: Dress,
    title: "Fashion",
