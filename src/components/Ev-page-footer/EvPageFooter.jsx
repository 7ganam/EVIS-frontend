        ...
        <Grid container spacing={4} columns={{ xs: 12, md: 13 }}>
          <Grid item md={4} sm={6} xs={12}>
            ...
            >
              <Link href='/'>
                <a>
                  <BazarImage height={80} src='/assets/images/NirvanaLogo.png' alt='logo' />
                </a>
              </Link>
            </Box>
            <Paragraph mb={2.5} color='grey.300' maxWidth='370px'>
              Nirvana Holding organizes B2B and B2C events in different markets and industries.
            </Paragraph>
          </Grid>
            ...
            <Box>
              ...
              {quickLinks.map((item, ind) => (
                <Link href={item.link} key={ind} passHref>
                  <StyledLink sx={{ textTransform: 'uppercase' }}>{item.label}</StyledLink>
                </Link>
              ))}
            </Box>
          </Grid>
          ...
          <Grid item md={3} sm={6} xs={12}>
            ...
            <SectionElement>
              <FlexBox alignItems='center'>
                ...
                <Span ml={1.5} className='title'>
                  <a href='mailto: evis@nirvanaholding.com'>evis@nirvanaholding.com</a>
                </Span>
              </FlexBox>
            </SectionElement>
            <SectionElement>
            ...
            <SectionElement>
              <FlexBox alignItems='center'>
                <Span ml={1.5} className='title' sx={{ fontWeight: '700', textDecoration: 'underline' }}>
            ...
            <SectionElement>
              ...
              <FlexBox alignItems='center'>
                <Span ml={1.5} className='title'>
                  <a href='mailto: zayid.ahamed@nirvanatls.com'>zayid.ahamed@nirvanatls.com</a>
                </Span>
              </FlexBox>
            </SectionElement>
            ...
            <SectionElement>
              <FlexBox alignItems='center'>
                <Span ml={1.5} className='title'>
                  <a href='mailto: theanleoua.chu@nirvanatls.com'>theanleoua.chu@nirvanatls.com</a>
                </Span>
              </FlexBox>
            </SectionElement>
            ...
            <SectionElement>
              <FlexBox alignItems='center'>
                <Span ml={1.5} className='title'>
                  <a href='mailto: jessy.suraj@nirvanatls.com'>jessy.suraj@nirvanatls.com</a>
                </Span>
              </FlexBox>
            </SectionElement>
          </Grid>
          ...
          <Grid item md={3} sm={6} xs={12}>
            ...
            <SectionElement>{'Venue: Abu Dhabi National Exhibition Centre, UAE'}</SectionElement>
            <SectionElement>
              {'Email: '}
