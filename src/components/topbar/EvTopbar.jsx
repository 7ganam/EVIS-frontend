...
const EvTopbar = () => {
  return (
    <TopbarWrapper>
      ...
      >
        <FlexBox className='topbarLeft' alignItems='center' sx={{ justifyContent: 'center', width: '100%' }}>
          <Box
            alignItems='center'
          ...
          >
            {'Under the Patronage of H.E. Suhail Mohamed Al Mazrouei , UAE Minister of Energy & Infrastructure'}
          </Box>
        </FlexBox>
      </Container>
    </TopbarWrapper>
