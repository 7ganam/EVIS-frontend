import FeedbackThumbsUp from "src/components/icons/FeedbackThumbsUp";
import Shield from "src/components/icons/Shield";
import Truck from "src/components/icons/Truck";
import Apple from "src/components/icons/Apple";
import Beer from "src/components/icons/Beer";
import Bottle from "src/components/icons/Bottle";
import Breakfast from "src/components/icons/Breakfast";
import Carrot from "src/components/icons/Carrot";
import Honey from "src/components/icons/Honey";
import Milk from "src/components/icons/Milk";
import Snack from "src/components/icons/Snack";
import Yogurt from "src/components/icons/Yogurt";
import CreditCardVerified from "src/components/icons/CreditCardVerified";
import CustomerService from "src/components/icons/CustomerService";
import AlarmClock from "src/components/icons/AlarmClock";
import MoneyGuarantee from "src/components/icons/MoneyGurantee";
import OnlineSupport from "src/components/icons/OnlineSupport";
import Payment from "src/components/icons/Payment";
import PickUpBox from "src/components/icons/PickUpBox";
import OnlineService from "src/components/icons/OnlineService"; // furniture shop page icons
