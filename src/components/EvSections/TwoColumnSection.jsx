...
const data = [
  {
    ...
    ps: [
      "The Electric & Hybrid Vehicle Technology Expo provides attendees the chance to find solutions to their application needs, get a look at the latest technologies, and connect with their peers.",
    ],
    direction: "left",
  },
  {
