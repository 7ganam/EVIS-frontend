...
import ModifiedRectangularTextContainer from "src/components/EvComponents/ModifiedRectangularTextContainer";
  ...
  return (
    <Box>
      ...
      <Container>
        ...
        >
          <Grid item xs={12} sm={6} md={6} sx={{ textAlign: "center" }}>
            <SectionTitle>{groupsTitle[0]}</SectionTitle>
          </Grid>
              ...
              {agenciesAndSuppliers.map(({ name }) => {
                return (
                  <Box item xs={12} sm={4} md={4} key={name}>
                    <ModifiedRectangularTextContainer
                      text={name}
      ...
      <Container>
        ...
        >
          <Grid item xs={12} sm={6} md={6} sx={{ textAlign: "center" }}>
            <SectionTitle>{groupsTitle[2]}</SectionTitle>
          </Grid>
          <Grid item xs={12} sm={6} md={6}>
            <Box
              sx={{
