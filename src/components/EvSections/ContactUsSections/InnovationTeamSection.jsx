...
const InnovationTeamSection = () => {
    return (
        <Container>
            ...
            <Grid container spacing={5} sx={{ textAlign: "center", placeItems: "start", marginTop: "40px", alignItems: "stretch" }}>
                {data.map(({ Src, Name, Position, Mobile, Email, EmailTo }) => {
                    return (
                        <Grid item xs={12} sm={6} md={4} key={Name}>
                            <RectangularInfoImage imageSrc={Src} title={Position} name={Name} tel={Mobile} email={Email} emailTo={EmailTo} />
                        </Grid>
                    )
                })}
            </Grid>
