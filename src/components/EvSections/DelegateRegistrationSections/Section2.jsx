...
import { H3, H5, H6, Paragraph } from "components/EvComponents/Typography";
    ...
    return (
        <Box>
            ...
            <Box sx={{
                ...
                <H5>
                    If you would like to register and pay via bank transfer or cheque, please contact Vilma Ducay at vilma.ducay@nirvanatls.com or +971 50 686 3740.
                </H5>
            </Box>
            <Container>
